...
//        printProtoBuffBody(requestBody);
    ...
    public static AlphaMessageOuterClass.AlphaMessage buildAlphaMessage(int cmdId,String version,byte[] requestBody,long sendSerial, long responseSerial) {
//        printProtoBuffBody(requestBody);
        AlphaMessageHeaderOuterClass.AlphaMessageHeader.Builder headerBuilder = AlphaMessageHeaderOuterClass.AlphaMessageHeader.newBuilder();
        headerBuilder.setCommandId(cmdId);
        headerBuilder.setVersionCode(version);
        ...
        builder .setHeader(headerBuilder.build());
        if(requestBody != null) {
            ByteString body = ByteString.copyFrom(requestBody);
            builder.setBodyData(body);
        }
    ...
    public static AlphaMessageOuterClass.AlphaMessage buildAlphaMessage(int cmdId,String version,GeneratedMessageV3 requestBody,long sendSerial, long responseSerial) {
//        printProtoBuffBody(requestBody);
        AlphaMessageHeaderOuterClass.AlphaMessageHeader.Builder headerBuilder = AlphaMessageHeaderOuterClass.AlphaMessageHeader.newBuilder();
        headerBuilder.setCommandId(cmdId);
        headerBuilder.setVersionCode(version);
