...
public class SwipeMenuRecyclerView extends RecyclerView {
    ...
    private static class ItemLongClick implements SwipeItemLongClickListener {
        ...
        public ItemLongClick(SwipeMenuRecyclerView recyclerView, SwipeItemLongClickListener
                callback) {
            this.mRecyclerView = recyclerView;
            this.mCallback = callback;
        }
    ...
    private static class MenuItemClick implements SwipeMenuItemClickListener {
        ...
        public MenuItemClick(SwipeMenuRecyclerView recyclerView, SwipeMenuItemClickListener
                callback) {
            this.mRecyclerView = recyclerView;
            this.mCallback = callback;
        }
    ...
    public void setLayoutManager(LayoutManager layoutManager) {
        if (layoutManager instanceof GridLayoutManager) {
            ...
            final GridLayoutManager.SpanSizeLookup spanSizeLookupHolder = gridLayoutManager
                    .getSpanSizeLookup();

            gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                @Override
                public int getSpanSize(int position) {
                    if (mAdapterWrapper.isHeaderView(position) || mAdapterWrapper.isFooterView
                            (position)) {
    ...
    public void setAdapter(Adapter adapter) {
        ...
        if (adapter == null) {
            ...
            mAdapterWrapper = new SwipeAdapterWrapper(getContext(), adapter,customBackground);
    ...
    public void onScrolled(int dx, int dy) {
        ...
        if (layoutManager != null && layoutManager instanceof LinearLayoutManager) {
            ...
            if (itemCount == lastVisiblePosition + 1 &&
                    (mScrollState == SCROLL_STATE_DRAGGING || mScrollState ==
            ...
            int[] lastVisiblePositionArray = staggeredGridLayoutManager
