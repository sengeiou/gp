...
public class StateView extends View {
    ...
    public static StateView inject(@NonNull Activity activity) {
        ViewGroup rootView = (ViewGroup) activity.getWindow().getDecorView().findViewById(
    ...
    private static StateView inject(@NonNull ViewGroup parent, boolean hasActionBar,
        ...
        StateView stateView = new StateView(parent.getContext());
        parent.addView(stateView);
        stateView.setTopMargin(isActivity, hasActionBar);
        return stateView;
    }
     ...
     */
    @Deprecated
    public void setTopMargin(boolean isActivity, boolean hasActionBar) {
        ViewGroup.MarginLayoutParams layoutParams
    ...
    private int getActionBarHeight() {
        ...
        int height = (int) getContext().getResources().getDimension(R.dimen.dp_45);
        return height;
    }
    ...
    protected void onAttachedToWindow() {
        ...
        LogUtils.d("lifecycle", "StateView:onAttachedToWindow");
    }

    @Override
    protected void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        LogUtils.d("lifecycle", "StateView:onDetachedFromWindow");
    }

    @Override
    protected void onFinishInflate() {
        super.onFinishInflate();
        LogUtils.d("lifecycle", "StateView:onFinishInflate");
    }
}
