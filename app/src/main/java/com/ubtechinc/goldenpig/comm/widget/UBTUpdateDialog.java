 ...
 */
public class UBTUpdateDialog extends BaseDialog implements View.OnClickListener {
    ...
    public UBTUpdateDialog(@NonNull Context context) {
        this(context, 0);
    }

    public UBTUpdateDialog(@NonNull Context context, int themeResId) {
        super(context, themeResId);
        init();
    }

    protected UBTUpdateDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
        init();
    }

    private void init() {
        View root = View.inflate(getContext(), R.layout.dialog_ubt_update, null);
