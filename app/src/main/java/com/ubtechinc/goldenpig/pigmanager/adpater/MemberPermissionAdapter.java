...
public class MemberPermissionAdapter extends RecyclerView.Adapter<MemberPermissionAdapter.MemberHolder> {
    ...
    public MemberHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_permission_member, parent, false);
    ...
    public void update(ArrayList<CheckBindRobotModule.User> userList) {
